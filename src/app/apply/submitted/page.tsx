    ...
    <main className="min-h-screen bg-[#f7f5ef] px-4 py-10 text-[#1f2724] sm:px-6 lg:px-8">
      <section className="mx-auto max-w-3xl border border-[#d8d1c3] bg-white p-6 sm:p-8">
        ...
        {payment && amountLabel && applicationRecord && paymentRequested && !applicationProcessing ? (
          <div className="mt-6 border border-[#d8d1c3] bg-[#fffdf8] p-4">
            ...
            <div className="mt-3 space-y-3">
                  ...
                  {shouldShowUploadForm && application && applicationRecord ? (
                    <EftProofUploadForm
                      applicationId={application}
                      publicToken={applicationRecord.publicToken}
                      action={uploadEftProof}
                    />
                  ) : null}
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {applicationRecord && payment?.status === PaymentStatus.PENDING && paymentRequested ? (
            <Link
              href={`/client/${encodeURIComponent(applicationRecord.publicToken)}`}
