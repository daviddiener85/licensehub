...
export async function createMandatePdf(input: MandatePdfInput) {
  ...
  const leftX = margin;
  const rightX = 318;
  drawField(page, "Register", valueOrLine(input.registrationNumber), leftX, y, 240, 82, fonts);
  ...
  drawText(page, "Generated by The License Hub", margin, 19, 10, bold, rgb(1, 1, 1));
